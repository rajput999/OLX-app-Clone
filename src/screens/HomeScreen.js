...
const HomeScreen = () => {
  ...
  return (
    <View style={styles.container}>
        {selectedTab==0?<Home/>:selectedTab==1?<Search/>:selectedTab==2?<Add onPost={()=>{setSelectedTab(0)}}/>:selectedTab==3?<Wishlist/>:<User/>}
        <View style={styles.bottomTabs}>
            <TouchableOpacity style={styles.tab} onPress={()=>{setSelectedTab(0)}}>
                <Image source={require('../images/house.png')} style={[styles.tabIcon, {tintColor:selectedTab==0?'blue':'black'}]} />
            </TouchableOpacity>
            ...
            <TouchableOpacity style={styles.tab} onPress={()=>{setSelectedTab(2)}}>
                <Image source={require('../images/add.png')} style={[styles.tabIcon, {tintColor:selectedTab==2?'blue':'black'}]} />
            </TouchableOpacity>
